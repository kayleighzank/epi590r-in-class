...
median_sleep_weekend <- inline_text(table_part_7, variable = sleep_wknd, column = "stat_0")
```

The median hours of sleep on weekends of the cohort was `r median_sleep_weekend`.
